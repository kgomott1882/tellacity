-- =============================================================================
-- Tellacity — "Mark review as helpful" (tables, triggers, like_count, grants)
--
-- EASIEST WAY TO FIX THE MODAL / OTP FLOW:
...
-- Server-side API uses service_role; these grants are defensive on some setups.
