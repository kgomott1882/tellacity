...
--   • You created an older / partial table (missing payload, suggester_email, etc.), OR
--   • POST /api/business/suggest fails with column / schema errors.
-- Idempotent. Then retry "Send verification code".
