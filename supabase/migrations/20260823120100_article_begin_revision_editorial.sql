-- begin_article_revision: copy editorial/SEO fields into new revision rows.
...
begin
  ...
  values (
    ...
    v_article.featured_image_alt,
    v_article.featured_image_width,
    v_article.featured_image_height,
    ...
    v_article.author_bio,
    v_article.author_avatar_url,
    v_article.meta_title,
    v_article.meta_description,
    v_article.key_takeaways,
    v_article.faq,
    v_article.tags,
    v_article.primary_keyword,
    v_article.target_audience,
    v_article.content_goal,
    'draft'
  )
