-- If 20260805120000 was already applied with the slow correlated-subquery version,
-- this migration replaces the function with the set-based implementation (fixes timeouts).
