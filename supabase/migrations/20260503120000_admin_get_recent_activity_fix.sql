-- Replace admin_get_recent_activity: populate business email (owner, business_profiles, listing, OTP)
-- and align title/subtitle with admin table (Type / Business columns).
