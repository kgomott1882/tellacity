...
import { getPaidPlanEntryPriceLabel, PAID_PLAN_USD } from "@/lib/billingPlanConfirm";
...
export default function ComparePage() {
  ...
  const tableRows = [
    ...
    },
    {
      ...
      tellacity: `${getPaidPlanEntryPriceLabel()} (clear, fixed tiers)`,
          ...
          <div className="space-y-4">
            <div className="rounded-xl border border-white/10 bg-white/[0.02] p-4">
              ...
              <p className="text-sm text-white">
                Tellacity offers clear, fixed pricing starting at ${PAID_PLAN_USD.grow.monthly}/month with no hidden tiers. Other platforms like
