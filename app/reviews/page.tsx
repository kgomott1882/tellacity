...
export const metadata = {
  title: "Customer Reviews & Guides | Tellacity",
  description:
    "Explore customer review guides, insights, and real experiences across global businesses on Tellacity.",
  alternates: {
    canonical: "https://tellacity.com/reviews",
  },
  openGraph: {
    title: "Customer Reviews & Guides | Tellacity",
    description:
  ...
  twitter: {
    ...
    title: "Tellacity Review Guides",
    description:
      "Explore guides and real customer experiences on Tellacity.",
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "CollectionPage",
            name: "Tellacity Reviews & Guides",
            url: "https://tellacity.com/reviews",
            description:
              "Explore customer review guides, insights, and real experiences across global businesses.",
          }),
        }}
      />
