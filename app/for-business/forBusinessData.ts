...
export {
  ...
  PLATFORM_CARDS,
  TEAM_USE_CASES,
} from "../reputation-platform/reputationPlatformData";

export const ARTICLES_PLATFORM = {
  title: "Blogs & Case Studies",
  lead:
    "Publish industry insights and documented client outcomes from your dashboard after Tellacity review. Free plans can save drafts; Grow and higher plans include monthly submission credits.",
  bullets: [
    "WordPress-style editor with anchor links, featured images, and case study fields",
    "Link validation and Business Guidelines review before anything goes live",
...
const PLATFORM_FAQ_SUPPLEMENT = [
  ...
  },
  {
    ...
    answer:
      "Yes. Many businesses start with review invitations or reputation management and add modules later. Because everything shares the same platform, turning on widgets, analytics, or articles never means migrating data or reconciling conflicting sources.",
  },
  {
    question: "How quickly does the platform integrate with my site?",
    answer:
      "Most businesses are live in under a day: claim your profile, send your first review invitations, and add a widget snippet to your site. There is no build step, no framework lock-in, and no separate logins between modules.",
  },
  {
...
export const FAQ_ITEMS = [
  ...
  {
    question: "Can we publish blogs and case studies?",
    answer:
      "Yes. Verified businesses can publish blogs and case studies from the dashboard after Tellacity review. Free plans can save drafts; Grow and higher plans include monthly submission credits. See Business Guidelines and Plans & Pricing for limits, link rules, and content standards.",
  },
  ...PLATFORM_FAQ_SUPPLEMENT,
];

export const LEADER_POINTS = [
  {
...
export const AUDIENCES = [
  {
    ...
    image: "/brand/White_male_plumber_at_work.jpeg",
  ...
  },
  {
    ...
    image: "/brand/Online%20Business%20Payments.jpeg",
  ...
  },
  {
    ...
    image: "/brand/Restaurant%20Team.jpeg",
    icon: "trendingUp" as const,
    tag: "Growing Teams",
    accent: "teal" as const,
  },
...
export const MARQUEE_TEXT =
  "✓ Verified Reviews Only  ·  ✓ No Pay-to-Hide  ·  ✓ Right of Reply  ·  ✓ Built for Long-Term Trust  ·  ✓ Fair Moderation  ·  ✓ One Verified Pipeline  ·";

export const GOAL_TAGS = ["Engage", "Convert", "Improve", "Grow"];

export const SIZE_TAGS = ["Small & Growing", "Established & Multi-Location"];
