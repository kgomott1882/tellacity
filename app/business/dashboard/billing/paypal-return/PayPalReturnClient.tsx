...
type Phase = "capturing" | "done" | "missing_params" | "capture_failed";
...
export default function PayPalReturnClient() {
  ...
  if (phase === "missing_params") {
    return (
      <div className="mx-auto flex min-h-[50vh] max-w-md flex-col justify-center px-4 py-16 text-center">
        ...
        <p className="mt-2 text-sm text-gray-600">
          This page needs a valid PayPal order. If you closed the payment window, you can try
          again from billing.
        </p>
        <Link
          href="/business/dashboard/billing"
          className="mt-8 inline-flex items-center justify-center rounded-xl bg-[#003087] px-5 py-3 text-sm font-semibold text-white hover:bg-[#001f5c]"
        >
          Back to billing
        </Link>
      </div>
    ...
    return (
      <div className="mx-auto flex min-h-[50vh] max-w-md flex-col justify-center px-4 py-16 text-center">
        ...
        <p className="mt-3 text-xs text-gray-500">
          If you were charged, contact support with your PayPal transaction ID from your receipt.
        </p>
        <Link
          href="/business/dashboard/billing"
          className="mt-8 inline-flex items-center justify-center rounded-xl bg-[#003087] px-5 py-3 text-sm font-semibold text-white hover:bg-[#001f5c]"
  ...
  return (
    <div className="mx-auto flex min-h-[50vh] max-w-md flex-col items-center justify-center px-4 py-16 text-center">
      ...
      />
      <p className="mt-4 text-sm text-gray-600">Confirming your payment with PayPal…</p>
    </div>
  );
}
